...
# certaines bibliothèques Python (équivalent de build-essential sur Alpine)
...
# Certaines bibliothèques peuvent nécessiter les outils de build installés ci-dessus
